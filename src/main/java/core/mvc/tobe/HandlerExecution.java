...
public class HandlerExecution implements ExecuteHandler {
    ...
    public ModelAndView handle(HttpServletRequest request, HttpServletResponse response) throws Exception {
        List<Object> parameters = parameters(request, response);
    ...
    // FIXME s parameters 메서드 이름, 내부 구현 정리 하고 리뷰 요청
    private List<Object> parameters(HttpServletRequest request, HttpServletResponse response) {
